...
//        self.topSchoolsViewModel.getTopSchools()
    ...
    func style() {
        ...
        numberOfSchools.attributedPlaceholder = NSAttributedString(string: "#", attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
    ...
    func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            numberOfSchools.heightAnchor.constraint(equalTo: topSchoolsHeaderView.filterStackView.heightAnchor, multiplier: 0.2),
